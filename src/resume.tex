...
\resheading{Summary}
	\begin{itemize}
		\resitem{7+ years building ML infrastructure at scale, from model serving platforms to GPU training clusters managing 500+ GPUs.}
		\resitem{Experience spanning model hosting, LLM serving, training infrastructure, and developer tooling across Kubernetes and cloud environments.}
		\resitem{Open source contributor: Apache Airflow Taskflow API (shipped in 2.0), TFX, Triton Server.}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item
			...
			\begin{itemize}
				...
				\resitem{Worked with industry collaborators from Spotify and Google for alignment on reusable components for automatic model re-training pipelines.}
			\end{itemize}
		\item
...
\resheading{Skills}
	\begin{itemize}
		\resitem{\textbf{Programming:} Python, Go, Terraform. \textbf{Infrastructure:} Kubernetes, EKS, Helm, ArgoCD, Slurm, vLLM, gRPC, AWS, GCP. \textbf{Data \& ML:} Kubeflow Pipelines, Apache Airflow, Spark, Kafka.}
