...
\resheading{Experience}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\resitem{Built inference request archival and evaluation logging system, now logging 19B+ prediction records monthly across 145 production ML models for model debugging, statistical analysis, and quality assessment.}
